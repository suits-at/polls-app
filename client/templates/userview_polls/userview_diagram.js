...
(function() {
  Template.userview_diagram.onCreated(function() {
  ...
  Template.userview_diagram.generateColumnChart = function() {
    return {
      chart: {
        type: 'column'
      },
  ...
  Template.userview_diagram.generatePieChart = function() {
    return {
      chart: {
  ...
  Template.userview_diagram.onRendered(function() {
    return new Vue({
      el: '#polls_diagram',
      data: {
        optiontitle: '',
